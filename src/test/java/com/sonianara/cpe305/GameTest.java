...
public class GameTest {
	...
	public void TestGame() {
		...
		//ArrayList<Location> newLocations = game.getNewLetterLocation(previousBoard, currentBoard);
		...
		//ArrayList<Location> newLocations2 = game.getNewLetterLocation(currentBoard, newBoard);
